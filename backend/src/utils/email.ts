...
// API key guardada como secret de Firebase:
// npx firebase-tools secrets:set RESEND_API_KEY
const resend = new Resend(process.env.RESEND_API_KEY)

const FROM = 'BarberFlow <noreply@barberflow.app>' // cambia por tu dominio verificado en Resend
