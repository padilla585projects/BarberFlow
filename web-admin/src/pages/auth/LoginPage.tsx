    ...
    <div className={styles.container}>
      ...
      <div className={styles.brand}>
        ...
        <div className={styles.brandTop}>
          <img src="/logo.png" alt="BarberFlow" style={{ width: 130, height: 130, borderRadius: '50%' }} />
        </div>
...
function EmailIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" style={{ flexShrink: 0 }}>
      ...
      <path d="M2 7l9.293 6.293a1 1 0 001.414 0L22 7" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/>
    </svg>
  )
}
